      ...
      <div class="row">    
        ...
        <button class="btn btn-success btnAgregar">Nuevo</button>
            ...
            <?php
                    ...
                    <tr>                
                      <td><?php echo $d[0]?></td>
                      <td><a href="AuditMenuPrincipal.php?cod=<?=$d[1]?>" class='btns2' style="text-decoration:none;color: #fff;">Ingresar</a>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                              ...
                              <a type="button" href="IngresoEmpresa.php" class="close" data-dismiss="modal">&times;</a>
                            </div>                       
                            <div class="modal-body" style="padding-top: 1px;">
                              
                            </div>
                            <div class="modal-footer">
                                <a type="button"  href="IngresoEmpresa.php" class="btn btn-default" data-dismiss="modal">Cancelar</a>
                            </div>
                        </div>
                    </div>
                  </div>
