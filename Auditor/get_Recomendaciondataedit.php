...
if(isset($_POST['editRecomendacion'])){
    ...
    $emp=$obj->UpdateRecomendacion($id);
    $response = " 
    ...
    <form role='form' method='post' name='updateRecomendacion' id='updateRecomendacion' action='../controlador/OperacionRecomendacionInsertar.php'>   
    ...
    $response .= "<input type='text' style='width:200px;' class='form-control' id='recomendacion' name='recomendacion' value='$var'  autocomplete='off'>";
